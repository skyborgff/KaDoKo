    ...
    methods: {
      ...
      display_graph(res) {
        ...
        function toggle_visibility(visible) {
          ...
          if (!visible){Graph.cooldownTicks(10)}
      ...
      LinkStatus(link) {
        ...
        var source_count = this.NodeLinksCount[source.id];// eslint-disable-line no-unused-vars
        var target_count = this.NodeLinksCount[target.id];// eslint-disable-line no-unused-vars
